...
abstract class AppConstants {
  ...
  static const List<CustomService> services = [
    CustomService(
      ...
      description:
          'I am a mobile app developer. I have experience using Dart,Flutter SDK and Rest APIs.',
    ),
    CustomService(
    ...
    CustomService(
      ...
      description:
      'I am a web developer. I have experience using HTML, CSS, JavaScript, React, Flutter Web, Node.js, and Rest APIs.',
    ),
  ];
